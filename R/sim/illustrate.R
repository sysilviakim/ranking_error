...
text(x=2.5,y=0.38, labels="Sincere Responses", 
     cex=1.2, col="darkcyan", font=2)
text(x=1.5,y=0.18, labels="Observed Data", 
...
arrows(x0=5.6-0.5,x1=5.7+0.5,y0=0.35,y1=0.35,length=0,col="dimgray")
rect(xleft=0.6, ybottom=0, xright=1.4, ytop=p_raw$Freq[1], 
     col=alpha("dimgray",0.3), lty=0)
rect(xleft=1.6, ybottom=0, xright=2.4, ytop=p_raw$Freq[2], 
     col=alpha("dimgray",0.3), lty=0)
rect(xleft=2.6, ybottom=0, xright=3.4, ytop=p_raw$Freq[3], 
     col=alpha("dimgray",0.3), lty=0)
rect(xleft=3.6, ybottom=0, xright=4.4, ytop=p_raw$Freq[4], 
     col=alpha("dimgray",0.3), lty=0)
rect(xleft=4.6, ybottom=0, xright=5.4, ytop=p_raw$Freq[5], 
     col=alpha("dimgray",0.3), lty=0)
rect(xleft=5.6, ybottom=0, xright=6.4, ytop=p_raw$Freq[6], 
     col=alpha("dimgray",0.3), lty=0)
