...
ggdt %>%
  ...
  ggtitle("Pr(gender > race > party > religion)") -> p_main1
...
ggdt %>%
  ...
  labs(caption = "Predictions for 40yo, white, male, with mid-level edu, independent, in northeast") +
  theme(plot.caption = element_text(hjust = 0)) +  
  ggtitle("Pr(party > gender > race > religion)") -> p_main2
...
ggdt %>%
  ...
  labs(caption = "Predictions for 40yo, white, male, with mid-level edu, independent, in northeast") +
  theme(plot.caption = element_text(hjust = 0)) +    
  ggtitle("Pr(party > gender > race > religion)") -> p
...
ggdt %>%
  ...
  labs(caption = "Predictions for 40yo, white, male, with mid-level edu, independent, in northeast") +
  theme(plot.caption = element_text(hjust = 0)) +  
  ggtitle("Pr(gender > race > religion > party)") -> p_main3

p_main3

ggsave(here::here("fig", "placketluce_weight3.pdf"),
       width = 5, height = 3.5
)
...
ggdt %>%
  ...
  labs(caption = "Predictions for 40yo, white, male, with mid-level edu, independent, in northeast") +
  theme(plot.caption = element_text(hjust = 0)) +  
  ggtitle("Pr(religion > gender > race > party)") -> p_main4

p_main4

ggsave(here::here("fig", "placketluce_weight4.pdf"),
       width = 5, height = 3.5
)
