...
# THE FOLLOWING ALGORITHMS FOLLOW Xia (2019, 20-22) "Learning and Decision-Making from Rank Data"
...
gamma.true <- prob
R.set <- matrix(nrow=N, ncol=t, NA) # STORAGE OF RANKINGS with N-rows and t-columns
...
draw <- rmultinom(n=1, size=1, prob=gamma) # DRAW FROM A MULTINOMIAL PMF
